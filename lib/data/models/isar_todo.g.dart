...
void _todoIsarSerialize(
  ...
  writer.writeBool(offsets[0], object.isComplated);
...
TodoIsar _todoIsarDeserialize(
  ...
  object.id = id;
  object.isComplated = reader.readBool(offsets[0]);
...
extension TodoIsarQueryFilter
  ...
  QueryBuilder<TodoIsar, TodoIsar, QAfterFilterCondition> isComplatedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isComplated',
        value: value,
      ));
    });
  }
...
extension TodoIsarQuerySortBy on QueryBuilder<TodoIsar, TodoIsar, QSortBy> {
  QueryBuilder<TodoIsar, TodoIsar, QAfterSortBy> sortByIsComplated() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isComplated', Sort.asc);
    });
  }

  QueryBuilder<TodoIsar, TodoIsar, QAfterSortBy> sortByIsComplatedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isComplated', Sort.desc);
    });
  }
...
extension TodoIsarQuerySortThenBy
  ...
  QueryBuilder<TodoIsar, TodoIsar, QAfterSortBy> thenByIsComplated() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isComplated', Sort.asc);
    });
  }

  QueryBuilder<TodoIsar, TodoIsar, QAfterSortBy> thenByIsComplatedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isComplated', Sort.desc);
    });
  }
...
extension TodoIsarQueryWhereDistinct
  ...
  QueryBuilder<TodoIsar, TodoIsar, QDistinct> distinctByIsComplated() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isComplated');
    });
  }
...
extension TodoIsarQueryProperty
  ...
  QueryBuilder<TodoIsar, bool, QQueryOperations> isComplatedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isComplated');
    });
  }
